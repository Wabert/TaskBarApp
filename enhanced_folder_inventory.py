...
class FolderInventoryDialog(CustomDialog):
    ...
    def __init__(self, parent):
        super().__init__(parent, "Folder Inventory", width=500, height=400)
    ...
    def create_form(self):
        ...
        # Folder selection
        folder_frame = tk.Frame(self.dialog_content, bg=Colors.LIGHT_GREEN)
        folder_frame.pack(fill=tk.X, pady=5)
        
        self.folder_field = FormField(folder_frame, "Folder to scan:", width=35)
